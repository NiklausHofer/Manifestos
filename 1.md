...
In this setting, you specify the cipher suite to communicate with the server, and not the ciphers your secret certificate supports. You can break the connection with other servers!
