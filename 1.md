...
**Warning! Leave the defaults s2s list ciphers alone!** Remember the correct cipher list, otherwise you will not be able to connect to the servers. Do not try to enumerate ciphers yourself, because certificates can be used in the future by other ciphers
