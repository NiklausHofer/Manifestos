...
### Warning! Leave the defaults s2s list ciphers alone! 
...
This set includes **ECC (ECDHE-ECDSA) and RSA (ECDHE-RSA)** ciphers. This is right now, but will not work in the future!In the future, new ciphers will appear and the setting will be incorrect. To upgrade the certificate class, use the ECC certificate instead of RSA, and not guessing with cipher suites!
